...
const OfflinePagePage = () => {
  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-sfpro items-start justify-start mx-auto pr-10 sm:pr-5 py-10 w-full">
        <div className="flex flex-col items-start justify-start mb-[25px] md:px-5 w-[92%] md:w-full">
          <div className="flex flex-col md:gap-10 gap-[117px] items-center justify-start md:ml-[0] ml-[195px] w-[89%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              ...
              <div className="flex md:flex-1 flex-col gap-2.5 items-center justify-start md:ml-[0] ml-[45px] md:mt-0 mt-8 w-[5%] md:w-full">
                <Text
            ...
            <div className="flex flex-col gap-3 items-center justify-start w-[23%] md:w-full">
              ...
              <Line className="bg-gradient2  h-[5px] w-[77%]" />
            </div>
          </div>
          <div className="flex md:flex-col flex-row gap-5 items-center justify-between mt-[115px] w-full">
            <div className="bg-white-A700 flex flex-col items-start justify-start pr-[13px] py-[13px] rounded-[10px]">
            ...
            <div className="bg-white-A700 flex flex-col items-center justify-end p-[11px] rounded-[10px]">
              <div className="mt-0.5 overflow-x-auto w-[92%]">
                <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                  <Img
                    className="h-5 w-5"
                  ...
                  />
                  <Img
                    className="h-5 md:ml-[0] ml-[1324px] w-5"
            ...
            <div className="bg-deep_purple-A200 flex flex-col items-center justify-end p-3 rounded-[10px]">
          ...
          <div className="flex flex-col items-center justify-start md:ml-[0] ml-[195px] mt-[60px] w-[89%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
              ...
              <div className="flex md:flex-1 flex-row gap-2.5 items-center justify-center md:ml-[0] ml-[30px] w-[8%] md:w-full">
                <div className="bg-red-A700_33 flex flex-col h-[30px] items-center justify-start p-[5px] rounded-[50%] w-[30px]">
                  <div className="bg-red-A700_01 h-5 rounded-[50%] w-5"></div>
                </div>
                <Text
              ...
              <Text
                className="md:ml-[0] ml-[30px] sm:text-2xl md:text-[26px] text-[28px] text-white-A700"
                size="txtSFProMedium28WhiteA700"
              >
                0 results
              </Text>
              <Input
                ...
                wrapClassName="flex md:flex-1 md:ml-[0] ml-[66px] rounded-[10px] w-[34%] md:w-full"
                prefix={
                  <Img
                ...
                color="white_A700"
              ></Input>
              <div className="bg-white-A700_19 flex md:flex-1 flex-col items-center justify-end ml-5 md:ml-[0] p-[15px] rounded-[10px] w-1/4 md:w-full">
            ...
            <div className="flex flex-col gap-[49px] items-center justify-start mt-[250px] w-[53%] md:w-full">
              <Img
                className="h-[130px] w-[130px]"
                src="images/img_sademojisvgrepocom.svg"
                alt="sademojisvgrepo"
              />
              <Text
                className="md:text-5xl text-[65px] text-center text-white-A700"
                size="txtSFProMedium65"
              >
                We Can’t Find Any Collection
              </Text>
            </div>
            <div className="flex flex-col items-center justify-start mt-[237px] w-full">
...
export default OfflinePagePage;
