...
const RankingsPageOnePage = () => {
  const [group1000010222value, setGroup1000010222value] = React.useState("");

  return (
    <>
      <div className="bg-white-A700 flex flex-col font-sfpro items-center justify-start mx-auto p-10 sm:px-5 w-full">
        <div className="flex flex-col items-center justify-start max-w-[1530px] mb-[13px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
            <Text
              className="md:mt-0 mt-10 text-deep_purple-A200 text-xl"
              size="txtEbrimaBold20"
            >
              My
            </Text>
            <div className="font-alata md:h-[70px] h-[85px] ml-0.5 md:ml-[0] relative w-[5%] md:w-full">
              <Img
              ...
              />
              <div
                className="absolute bg-cover bg-no-repeat bottom-[0] flex flex-col h-[73px] inset-x-[0] items-start justify-start mx-auto p-2 w-full"
                style={{ backgroundImage: "url('images/img_group237.svg')" }}
              >
                <Text
                  className="my-[13px] text-white-A700 text-xl"
            ...
            <Input
              ...
              className="!placeholder:text-white-A700 !text-white-A700 font-sfpro p-0 text-left text-lg w-full"
            ...
            ></Input>
            <Text
              className="md:ml-[0] ml-[100px] md:mt-0 mt-[31px] text-black-900 text-xl"
              size="txtSFProRegular20Black900"
            >
              Home
            </Text>
            <div className="flex md:flex-1 flex-col font-sfpro gap-2.5 items-center justify-start md:ml-[0] ml-[45px] md:mt-0 mt-8 w-[4%] md:w-full">
              <Text
                className="text-black-900 text-xl"
                size="txtSFProSemibold20Black900"
              >
                Pages
              </Text>
              <Img
            ...
            <Text
              className="md:ml-[0] ml-[45px] md:mt-0 mt-8 text-black-900 text-xl"
              size="txtSFProRegular20Black900"
            >
              Explore
            </Text>
            <Text
              className="md:ml-[0] ml-[45px] md:mt-0 mt-[31px] text-black-900 text-xl"
              size="txtSFProRegular20Black900"
            >
              Resources
            </Text>
            <Text
              className="md:ml-[0] ml-[45px] md:mt-0 mt-[30px] text-black-900 text-xl"
              size="txtSFProRegular20Black900"
            >
              Create
            </Text>
            ...
            <Button
              className="flex h-[60px] items-center justify-center md:ml-[0] ml-[65px] md:mt-0 my-3 w-[60px]"
              shape="circle"
              color="black_900"
              size="md"
              variant="fill"
            ...
            <div className="flex md:flex-1 flex-col items-center justify-start ml-5 md:ml-[0] md:mt-0 mt-[13px] w-[60px] md:w-full">
              <Img
            ...
            <Button
              className="flex items-center justify-center ml-5 md:ml-[0] md:mt-0 my-[13px] w-[60px]"
              shape="circle"
              color="black_900"
              size="md"
              variant="fill"
            >
              <Img className="h-[30px]" src="images/img_moon.svg" alt="moon" />
            </Button>
          </div>
          <div className="flex flex-col gap-3 items-center justify-start mt-[119px] w-[19%] md:w-full">
            <div className="flex flex-row gap-[15px] items-start justify-between w-full">
              <Text
                ...
                size="txtSFProRegular38Black900"
              >
                Page
              </Text>
              <div className="bg-black-900 h-3 mb-[21px] mt-[13px] rounded-[50%] w-3"></div>
              <Text
                className="md:text-4xl sm:text-[34px] text-[38px] text-deep_purple-A200"
                size="txtSFProSemibold38"
              >
                Rankings{" "}
              </Text>
            </div>
            ...
            <div className="sm:h-[1004px] h-[1072px] md:h-[2147px] relative w-full">
              <div className="flex flex-col m-auto w-full">
                <div className="bg-deep_purple-A200 flex sm:flex-col flex-row sm:gap-5 items-center justify-start mx-auto p-[17px] rounded-tl-[15px] rounded-tr-[15px] w-full">
                  ...
                  <Text
                    className="sm:ml-[0] ml-[116px] text-2xl md:text-[22px] text-white-A700 sm:text-xl"
                    size="txtSFProSemibold24WhiteA700"
                  >
                    24 %
                  </Text>
              ...
              <div className="absolute bottom-[2%] flex md:flex-col flex-row md:gap-5 items-end justify-start left-[1%] w-[81%]">
                <div className="flex flex-col md:gap-10 gap-[76px] items-end justify-start md:mt-0 my-[17px] w-[2%] md:w-full">
            ...
            <div className="flex flex-col items-center justify-start w-full">
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
                <div className="flex md:flex-1 flex-col md:gap-10 gap-[63px] items-start justify-start w-[29%] md:w-full">
                  ...
                  <Text
                    className="leading-[38.00px] text-2xl md:text-[22px] text-black-900 sm:text-xl w-full"
                    size="txtSFProRegular24Black900"
                  >
                ...
                <div className="flex md:flex-1 md:flex-col flex-row md:gap-10 items-center justify-between md:mt-0 mt-[43px] w-[64%] md:w-full">
                  <div className="flex flex-col gap-[22px] items-center justify-start w-[17%] md:w-full">
                    <Text
                      ...
                      size="txtSFProSemibold28Black900"
                    >
                      Marketplace
                    </Text>
                  ...
                  >
                    <div className="flex flex-col gap-6 items-start justify-start mb-[45px] sm:ml-[0] w-full">
                      ...
                      <div className="flex flex-col items-start justify-start">
                        ...
                        <Text
                          className="mt-3.5 text-2xl md:text-[22px] text-black-900 sm:text-xl"
                          size="txtSFProRegular24Black900"
                        >
                          Contact Us
                        </Text>
                    ...
                    <div className="flex flex-col gap-[22px] items-start justify-start sm:ml-[0] w-full">
                      ...
                      <div className="flex flex-col items-start justify-start w-full">
                        ...
                        <Text
                          className="capitalize mt-[15px] text-2xl md:text-[22px] text-black-900 sm:text-xl"
                          size="txtSFProRegular24Black900"
                        >
                          trams and condition
                        </Text>
                        <Text
                          className="capitalize mt-[17px] text-2xl md:text-[22px] text-black-900 sm:text-xl"
                          size="txtSFProRegular24Black900"
                        >
                          privacy policy
                        </Text>
              ...
              <Line className="bg-gray-400_04 h-px mt-[34px] w-full" />
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-[19px] w-full">
                ...
                <div className="flex md:flex-1 flex-row font-mulish gap-[35px] items-center justify-between w-[24%] md:w-full">
                  <Text
                    className="capitalize text-[22px] text-black-900 sm:text-lg md:text-xl"
                    size="txtMulishSemiBold22Black900"
                  >
                    follow us :
                  </Text>
                  <div className="flex flex-row gap-5 items-center justify-between w-3/5">
                    ...
                    <div className="bg-black-900 flex flex-col h-[60px] items-center justify-end p-3 rounded-[50%] w-[60px]">
...
export default RankingsPageOnePage;
