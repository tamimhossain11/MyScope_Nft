      ...
      <div className="bg-black-900 flex flex-col font-sfpro items-end justify-start mx-auto pl-10 sm:pl-5 py-10 w-full">
        <div className="flex flex-col items-start justify-start mb-[153px] md:px-5 w-[92%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[89%] md:w-full">
            ...
            <div className="flex flex-row gap-5 items-center justify-between md:ml-[0] ml-[65px] md:mt-0 mt-[13px] w-[15%] md:w-full">
              ...
              <Img
                ...
                src="images/img_group1000009458_27.svg"
                alt="group1000009458"
              />
            </div>
          </div>
          <div className="flex flex-col gap-3 items-center justify-start md:ml-[0] ml-[553px] mt-[119px] w-1/4 md:w-full">
            <div className="flex sm:flex-col flex-row gap-[15px] items-center justify-between w-full">
              ...
              <Radio
                value="TrendingCards"
                className="font-bold md:text-4xl sm:text-[34px] text-[38px] text-deep_purple-A200 text-left"
            ...
            <Line className="bg-gradient2  h-[5px] w-[67%]" />
          </div>
          <div className="flex md:flex-col flex-row gap-5 items-center justify-between mt-[115px] w-full">
            ...
            <div className="bg-deep_purple-A200 flex flex-col items-center justify-end p-[11px] rounded-[10px]">
            ...
            <div className="flex flex-col items-center justify-start">
              <Img
                ...
                src="images/img_rectangle66522_8.png"
                alt="rectangle66522"
              />
            </div>
          </div>
...
export default TendingCardsPagePage;
