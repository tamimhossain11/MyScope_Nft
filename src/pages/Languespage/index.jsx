...
const languasOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const LanguespagePage = () => {
  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-sfpro items-start justify-start mx-auto py-10 w-full">
        <div className="flex flex-col items-start justify-start mb-[11px] md:px-5 w-full">
          <div className="flex md:flex-col flex-row md:gap-10 gap-[66px] items-center justify-end md:ml-[0] ml-[284px] w-[77%] md:w-full">
            ...
            <div className="flex flex-row gap-5 items-center justify-between w-[15%] md:w-full">
              ...
              <Img
                ...
                src="images/img_group1000009458_59x60.svg"
                alt="group1000009458"
              />
            </div>
          </div>
          <div className="mt-[5px] overflow-x-auto w-full">
            <div className="h-[1064px] sm:h-[1244px] md:h-[1946px] overflow-auto relative w-full">
              ...
              <div className="absolute sm:h-[1244px] md:h-[567px] h-[994px] right-[10%] top-[0] w-[28%] sm:w-full">
                <div
                  className="absolute bg-cover bg-no-repeat flex flex-col h-[572px] items-center justify-start p-[17px] right-[0] top-[0] w-[72%]"
                  style={{ backgroundImage: "url('images/img_group2829.svg')" }}
                >
                  <div className="flex flex-col items-center justify-start mb-[9px] mt-[35px] w-full">
                    <div className="flex flex-row gap-2.5 items-start justify-start w-[89%] md:w-full">
                      <Text
                    ...
                    <SelectBox
                      className="capitalize font-medium mt-[23px] text-left text-xl w-full"
                      placeholderClassName="text-white-A700"
                      indicator={
                        <Img
                          className="h-1.5 mr-[0] outline-white-A700 outline-[1px] outline w-3"
                      ...
                      name="group1000010164"
                      isMulti={false}
                      options={languasOptionsList}
                      shape="round"
                      color="deep_purple_A200"
                      size="sm"
                      variant="fill"
                    />
                    <div className="flex flex-col items-start justify-start mt-6 w-[34%] md:w-full">
                      <div className="flex flex-row gap-[15px] items-start justify-start w-[91%] md:w-full">
                        <Img
                          className="h-5 w-5"
                      ...
                      <div className="flex flex-row gap-[15px] items-center justify-between mt-[19px] w-full">
                        <Img
                          className="h-5 w-5"
                      ...
                      <div className="flex flex-row gap-2.5 items-start justify-start mt-[22px] w-[93%] md:w-full">
                        <Img
                          className="h-5 w-5"
                ...
                <div className="absolute bg-black-900 bottom-[0] flex flex-col items-end justify-start left-[0] sm:pl-5 pl-[25px] rounded-[15px] shadow-bs7 w-[95%]">
                  <div className="flex sm:flex-col flex-row gap-[30px] items-end justify-end w-full">
                    <div className="flex sm:flex-1 flex-col gap-5 items-center justify-start sm:mt-0 mt-[27px] w-[92%] sm:w-full">
                      <div className="bg-deep_purple-A200 flex sm:flex-col flex-row sm:gap-5 items-center justify-start p-2.5 rounded-[10px] w-full">
                        <Img
                          className="h-10 md:h-auto ml-2.5 sm:ml-[0] object-cover w-10"
                          src="images/img_unitedstate.png"
                          alt="unitedstate"
                        />
                        <Text
                          className="sm:ml-[0] ml-[15px] text-[22px] sm:text-lg text-white-A700 md:text-xl"
                          size="txtSFProSemibold22WhiteA700"
                        >
                          English
                        </Text>
                        <Button
                          className="flex h-10 items-center justify-center sm:ml-[0] ml-[248px] rounded-[50%] w-10"
                          color="white_A700_63"
                          size="md"
                          variant="fill"
                        >
                          <Img
                            className="h-4"
                            src="images/img_check2.svg"
                            alt="checkTwo"
                          />
                        </Button>
                      </div>
                      <div className="bg-white-A700_19 flex flex-row gap-[15px] items-center justify-start p-2.5 rounded-[10px] w-full">
                        <Img
                          className="h-10 md:h-auto object-cover w-10"
                          src="images/img_germanyflag.png"
                          alt="germanyflag"
                        />
                        <Text
                      ...
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="bg-white-A700_19 flex flex-row gap-[15px] items-center justify-start p-2.5 rounded-[10px] w-full">
                          <Img
                            className="h-10 md:h-auto object-cover w-10"
                            src="images/img_nicepngindones.png"
                            alt="nicepngindones"
                          />
                          <Text
                            className="text-[22px] sm:text-lg text-white-A700 md:text-xl"
                      ...
                      <div className="bg-white-A700_19 flex flex-row gap-[15px] items-center justify-start p-2.5 rounded-[10px] w-full">
                        <Img
                          ...
                          src="images/img_portugalflat.png"
                          alt="portugalflat"
                        />
                        <Text
                          className="text-[22px] sm:text-lg text-white-A700 md:text-xl"
                    ...
                    <div className="flex sm:flex-1 flex-col items-center justify-start w-[3%] sm:w-full">
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="bg-gray-400_04 flex flex-col items-start justify-start rounded-br-[15px] rounded-tr-[15px] w-full">
                          <div className="bg-white-A700 flex flex-col h-[15px] items-start justify-end p-[3px] rounded-tr-[50%] w-[15px]">
                            <Img
                              className="h-[7px] mt-0.5 w-[7px]"
                              src="images/img_maskgroup_black_900.svg"
                              alt="maskgroup_One"
                            />
                          </div>
                          <Line className="bg-white-A700 h-10 md:ml-[0] ml-[5px] mt-[5px] rounded-[3px] w-1.5" />
                          <div className="bg-deep_purple-A200 flex flex-col h-[15px] items-start justify-start mt-[492px] p-[3px] rounded-tr-[50%] w-[15px]">
                            <Img
                              className="h-[7px] mb-0.5 w-[7px]"
          ...
          <div className="flex flex-col md:gap-10 gap-[116px] items-center justify-start md:ml-[0] ml-[284px] mt-[119px] w-[77%] md:w-full">
            <List
          ...
          <Footer className="flex items-center justify-center md:ml-[0] ml-[89px] mt-[120px] w-full" />
        </div>
      </div>
    </>
  );
...
export default LanguespagePage;
