  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-sfpro items-end justify-start mx-auto pl-10 sm:pl-5 py-10 w-full">
        <div className="flex flex-col items-start justify-start mb-[172px] md:px-5 w-[92%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[89%] md:w-full">
            ...
            <div className="flex flex-row gap-5 items-center justify-between md:ml-[0] ml-[65px] md:mt-0 mt-[13px] w-[15%] md:w-full">
              ...
              <Img
                ...
                src="images/img_group1000009458_22.svg"
                alt="group1000009458"
              />
            </div>
          </div>
          <div className="flex flex-col gap-3 items-center justify-start md:ml-[0] ml-[567px] mt-[116px] w-[24%] md:w-full">
          ...
          <div className="flex md:flex-col flex-row gap-5 items-center justify-between mt-[115px] w-full">
            ...
            <Button
              ...
              leftIcon={
                <Img
                  className="h-5 mt-0.5 mb-px mr-[5px]"
                  src="images/img_materialsymbolsastrophotographyauto_white_a700.svg"
            ...
            <div className="flex flex-col items-center justify-start">
              <Img
                ...
                src="images/img_rectangle66522_3.png"
                alt="rectangle66522"
              />
            </div>
          </div>
          ...
          <div
            className="bg-cover bg-no-repeat flex flex-col h-[87px] items-start justify-start md:ml-[0] ml-[730px] mt-5 pt-[17px] px-[17px] w-[47%] md:w-full"
            style={{ backgroundImage: "url('images/img_group1000010221.svg')" }}
          >
            <div className="flex sm:flex-col flex-row sm:gap-10 gap-[83px] items-center justify-start md:ml-[0] ml-[13px] w-4/5 md:w-full">
              <Img
              ...
              <Img
                ...
                alt="polygonTwo"
              />
              <div className="bg-white-A700 h-[45px] sm:mt-0 my-3 rounded-[22px] w-[45px]"></div>
              <div className="bg-white-A700 h-[45px] sm:mt-0 my-3 w-[45px]"></div>
              <div className="bg-deep_purple-A200 flex flex-row items-center justify-between pl-3 py-3 w-[17%] sm:w-full">
                <div className="bg-white-A700 h-[45px] ml-[15px] rounded-bl rounded-br rounded-tl-[50%] rounded-tr-[22px] w-[45px]"></div>
                <div className="bg-white-A700 h-[45px] w-[2%]"></div>
              </div>
            </div>
          </div>
          ...
          <div className="flex sm:flex-col flex-row gap-[30px] items-center justify-start md:ml-[0] ml-[550px] mt-[65px] w-1/4 md:w-full">
            <Button
