    ...
    <>
      <div className="bg-black-900 flex flex-col font-sfpro items-end justify-start mx-auto pl-10 sm:pl-5 py-10 w-full">
        <div className="flex flex-col items-start justify-start mb-[153px] md:px-5 w-[92%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[89%] md:w-full">
            ...
            <div className="flex flex-row gap-5 items-center justify-between md:ml-[0] ml-[65px] md:mt-0 mt-[13px] w-[15%] md:w-full">
              ...
              <Img
                ...
                src="images/img_group1000009458_20.svg"
                alt="group1000009458"
              />
            </div>
          </div>
          <div className="flex flex-col gap-3 items-center justify-start md:ml-[0] ml-[659px] mt-[116px] w-[13%] md:w-full">
          ...
          <div className="flex md:flex-col flex-row gap-5 items-center justify-between mt-[115px] w-full">
            ...
            <div className="flex flex-col items-center justify-start">
              <Img
                ...
                src="images/img_rectangle66522_1.png"
                alt="rectangle66522"
              />
            </div>
          </div>
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[60px] w-[84%] md:w-full">
            <Button
              className="cursor-pointer flex items-center justify-center min-w-[180px]"
              leftIcon={
                <Img
            ...
            <div className="flex flex-row gap-2.5 items-center justify-center md:ml-[0] ml-[30px] md:mt-0 mt-[18px] w-[7%] md:w-full">
            ...
            <Input
              ...
              wrapClassName="flex md:ml-[0] ml-[30px] rounded-[10px] w-[36%] md:w-full"
              prefix={
                <Img
              ...
              color="white_A700"
            ></Input>
            <div className="bg-white-A700_19 flex flex-col items-center justify-end ml-5 md:ml-[0] p-[15px] rounded-[10px] w-[27%] md:w-full">
          ...
          <div className="flex md:flex-col flex-row gap-10 items-start justify-start mt-2 w-[89%] md:w-full">
            <div className="flex flex-col gap-[38px] items-center justify-start md:mt-0 mt-[52px] w-[32%] md:w-full">
              <div className="bg-white-A700 flex flex-col items-center justify-end p-[17px] rounded-[10px] w-full">
                <div className="flex flex-row items-center justify-between w-[99%] md:w-full">
                  ...
                  <Img
                    ...
                    src="images/img_materialsymbol_black_900_30x30.svg"
            ...
            <List
              className="sm:flex-col flex-row gap-[30px] grid md:grid-cols-1 grid-cols-2 w-[67%] md:w-full"
            ...
            >
              ...
              <div className="h-[728px] relative w-full">
                <Button
                  className="flex h-[70px] items-center justify-center mb-[-18px] ml-auto w-[70px] z-[1]"
                  shape="round"
                  color="white_A700_19"
                  size="lg"
                  variant="fill"
                ...
                <div className="h-[676px] mt-auto mx-auto w-full">
                  <Img
                    className="h-[676px] m-auto object-cover rounded-bl-[10px] rounded-br-[10px] rounded-tl-[245px] rounded-tr-[245px] w-full"
                    src="images/img_rectangle66483_9.png"
                    alt="rectangle66483"
          ...
          <div className="md:gap-5 gap-[30px] grid md:grid-cols-1 grid-cols-2 min-h-[auto] md:ml-[0] ml-[520px] mt-[30px] w-[59%]">
            <div className="h-[676px] relative w-full">
              <Img
                className="h-[676px] m-auto object-cover rounded-bl-[10px] rounded-br-[10px] rounded-tl-[245px] rounded-tr-[245px] w-full"
                src="images/img_rectangle66483_9.png"
