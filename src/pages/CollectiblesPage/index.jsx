  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-sfpro items-end justify-start mx-auto pl-10 sm:pl-5 py-10 w-full">
        <div className="flex flex-col items-start justify-start mb-[181px] md:px-5 w-[92%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[89%] md:w-full">
            ...
            <div className="flex flex-row gap-5 items-center justify-between md:ml-[0] ml-[65px] md:mt-0 mt-[13px] w-[15%] md:w-full">
              ...
              <Img
                ...
                src="images/img_group1000009458_21.svg"
                alt="group1000009458"
              />
            </div>
          </div>
          <div className="flex flex-col gap-3 items-center justify-start md:ml-[0] ml-[586px] mt-[116px] w-[21%] md:w-full">
          ...
          <div className="flex md:flex-col flex-row gap-5 items-center justify-between mt-[115px] w-full">
            ...
            <div className="flex flex-col items-center justify-start">
              <Img
                ...
                src="images/img_rectangle66522_2.png"
                alt="rectangle66522"
              />
            </div>
          </div>
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[60px] w-[89%] md:w-full">
            ...
            <Input
              ...
              color="white_A700"
            ></Input>
            <div className="bg-deep_purple-A200 flex flex-col items-center justify-end ml-5 md:ml-[0] p-[15px] rounded-tl-[10px] rounded-tr-[10px] w-1/4 md:w-full">
              <div className="flex flex-row items-start justify-between mt-[5px] w-[98%] md:w-full">
                ...
                <Img
                  className="h-7 w-7"
                  src="images/img_materialsymbol_white_a700_28x28.svg"
          ...
          <div className="h-[2854px] md:h-[4156px] sm:h-[8442px] relative w-[89%] md:w-full">
            ...
            <div className="absolute bg-black-900 h-[355px] right-[6%] rounded-bl-[10px] rounded-br-[10px] shadow-bs8 top-[0] w-1/4"></div>
          </div>
...
export default CollectiblesPagePage;
